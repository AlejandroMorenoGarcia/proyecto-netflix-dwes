...
<header class="fixed top-0 left-0 w-full z-50 bg-surface-container-low/95 backdrop-blur-md">
    <div class="h-20 w-full px-margin-lg flex items-center justify-between gap-space-md">
        <div class="flex items-center gap-space-lg shrink-0"><a class="flex items-center gap-space-sm"
                                                                data-path="inicio" href="#"><img alt="Retroflix Logo"
                                                                                                 class="h-8 w-auto object-contain"
                                                                                                 src="app/Views/frontend/img/logo.png"/><span
                    class="font-headline-sm text-headline-sm uppercase text-primary tracking-widest hidden sm:inline-block"></span></a>
        ...
        <nav class="hidden lg:flex items-center gap-space-lg"
             data-active-classes="text-primary-container font-headline-sm"><a
                ...
                class="font-headline-sm text-headline-sm uppercase text-on-surface-variant hover:text-on-surface transition-colors"
                data-path="mi-coleccion" href="#">COLECCIÓN</a><a
                class="font-headline-sm text-headline-sm uppercase text-on-surface-variant hover:text-on-surface transition-colors"
                data-path="admin-console-sys-op" href="#">CONSOLA</a></nav>
